    ...
    public function up()
    {
        DB::table('cms_content')->insert(
            [
                ...
                'content_block_4' => '<h3 class="page-home-title">Tuinvereniging Cronesteyn</h3><p><b>Adres:</b><br/>Boerenpad 1<br/>2322 LA Leiden</p>',
                'content_block_5' => '',
                'content_block_6' => '',
